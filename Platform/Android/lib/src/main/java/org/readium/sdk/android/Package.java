...
//        Log.i(TAG, "package nativePtr: "+nativePtr);
    ...
    public InputStream getInputStream(String relativePath, int bufferSize, boolean isRangeRequest) {
        if (EPub3.isDirectory)
            return nativeInputStreamForDirRelativePath(__nativePtr, container.getNativePtr(), relativePath, bufferSize, isRangeRequest);
        else
    ...
    public int getArchiveInfoSize(String relativePath) {
        if (EPub3.isDirectory)
            return nativeGetDirInfoSize(__nativePtr, container.getNativePtr(), relativePath);
        else
...
//			Log.i(TAG, "JSON: " + o.toString(2));
    ...
    private native InputStream nativeInputStreamForDirRelativePath(long nativePtr,
                                                                   long containerPtr, String relativePath, int bufferSize, boolean isRange);
    ...
    private native int nativeGetDirInfoSize(long nativePtr,
                                            long containerPtr, String relativePath);
